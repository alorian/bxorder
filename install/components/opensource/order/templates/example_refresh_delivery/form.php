...
<form action="" method="post" name="os-order-form" id="os-order-form">
                        ...
                        case 'LOCATION':
                            ...
                            <div class="location">
                                <select class="location-search" name="<?= $arProp['FORM_NAME'] ?>"
                                    ...
                                    <option
                                            data-data='<?
                                            echo \Bitrix\Main\Web\Json::encode($arProp['LOCATION_DATA']) ?>'
    ...
    <? foreach ($arResult['DELIVERY_ERRORS'] as $error):
        ...
        <div class="error"><?= $error->getMessage() ?></div>
    <? endforeach; ?>
    <div id="os-order-delivery-block">
        <? foreach ($arResult['DELIVERY_LIST'] as $arDelivery): ?>
            <label class="delivery-label delivery<?= $arDelivery['ID'] ?>">
                ...
                >
                <?= $arDelivery['NAME'] ?>,
                <span class="delivery-price"><?= $arDelivery['PRICE_DISPLAY'] ?></span>
            </label>
            <br>
        <? endforeach; ?>
    </div>
